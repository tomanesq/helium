...
Setup
---------
Configuring the github-merge tool for the Squorum repository is done in the following way:

    git config githubmerge.repository akcryptoguy/squorum
...
A script to optimize png files in the Squorum
