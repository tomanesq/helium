...
def setup_repos():
    ...
    if not os.path.isdir('squorum'):
        subprocess.check_call(['git', 'clone', 'https://github.com/akcryptoguy/helium.git', 'squorum'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/akcryptoguy/helium', help='Specify the URL of the repository. Default is %(default)s')
