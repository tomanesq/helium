...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Squorum address (e.g. %1)").arg("S7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
#endif
...
{
    // return if URI is not valid or is no Squorum: URI
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Squorum.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Squorum.lnk
