...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Squorum Core squorum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  squorum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded squorum transaction") + "\n" +
                               "  squorum-tx [options] -create [commands]   " + _("Create hex-encoded squorum transaction") + "\n" +
                               "\n";
