...
In order to support loading of multiple wallets in squorum-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is squorum.cpp.
...
Changes to squorum.cpp
----------------------
squorum.cpp is the entry point into squorum-qt, and as such, will require some minor modifications to provide hooks for
